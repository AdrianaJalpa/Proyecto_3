...
void setup(){
  ...
  Contemplador= new personaje2("Contemplador",200,6,1);
  Leviatan= new personaje3("Leviatan",200,4,2);
  Drider= new personaje4("Drider",200,10,3);
  Drow= new personaje5("Drow",200,8,4);
